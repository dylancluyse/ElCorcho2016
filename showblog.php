                    ...
                    <div class="blog-post-area">
                        ...
                        if($aantal==0){
                            ...
                            while($row = $STH->fetch()){
                                ...
                                $STHfoto = $DBH->prepare('SELECT fotonaam FROM tblblogfoto WHERE blogid = :blogid');
                                $STHfoto->bindParam(':blogid', $id);
                                $STHfoto->execute();
                                ...
                                <div class="single-blog-post">
                                    ...
                                    <img src="admin/doc/<?php echo $foto?>" alt="">

                                    <p><?php echo $blogtekst?></p>
                                </div>
