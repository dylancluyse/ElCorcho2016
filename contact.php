...
<head>
    ...
    <script>
        var myCenter=new google.maps.LatLng(51.04380,3.75284);
                    ...
                    <div class="shop-menu pull-right">
                        <ul class="nav navbar-nav">
                            ...
                            if(!isset($_SESSION['login'])){
                                ...
                                echo '<li><a href="contact.php?action=logout"><i class="fa fa-lock"></i> Afmelden</a></li>';
                            }
                ...
                <div class="col-sm-9">
                    ...
                    <div class="mainmenu pull-left">
                        <ul class="nav navbar-nav collapse navbar-collapse">
                            ...
                            <li><a href="contact.php?lang=nl" class="active">Contact</a></li>
        ...
        <div class="row">
            <div class="col-sm-8">
                <div class="contact-form">
                    <h2 class="title text-center">Stuur ons een berichtje.</h2>
                    <div class="status alert alert-success" style="display: none"></div>
                    <form id="main-contact-form" action="sendemail_contact.php" class="contact-form row" name="contact-form" method="post">
                        <div class="form-group col-md-6">
                            <input type="text" name="name" class="form-control" required="required" placeholder="naam">
                        </div>
                        <div class="form-group col-md-6">
                            <input type="email" name="email" class="form-control" required="required" placeholder="email-adres">
                        </div>
                        <div class="form-group col-md-12">
                            <input type="text" name="subject" class="form-control" required="required" placeholder="onderwerp">
                        </div>
                        <div class="form-group col-md-12">
                            <textarea name="message" id="message" required="required" class="form-control" rows="8" placeholder="typ hier uw bericht"></textarea>
                        </div>
                        <div class="form-group col-md-12">
                            <input type="submit" name="submit" class="btn btn-primary pull-right" value="Versturen">
                        </div>
                    </form>
                </div>
            </div>
            ...
            <div class="col-sm-4">
                <div class="contact-info">
                    ...
                    <address>
                        ...
                        <p>Vredeplein 12</p>
                        <p>9000 Gent</p>
                        <p>Telefoon: 09 347 23 11</p>
                        <p>BTW-nr: BE 0389.412.367</p>
                        <p>Email: info@elcorcho.be</p>
                    </address>
                    <div class="social-networks">
                        <h2 class="title text-center">Sociale media</h2>
                        <ul>
                            <li>
