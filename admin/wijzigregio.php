...
<head>
    ...
    if(isset($_POST['submit'])){
        ...
        $STHadd = $DBH->prepare('UPDATE tblregio SET regionaam = :regionaam WHERE regioid = :regioid');
...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
    ...
    <div class="container">
        ...
        $STH = $DBH->prepare('SELECT regionaam FROM tblregio WHERE regioid = :regioid');

        $regioid = $_GET['regioid'];

        $STH->bindParam(':regioid', $regioid);
        ...
        <form class="form-horizontal" id="form_members" role="form" action="wijzigregio.php?regioid=<?php echo $regioid;?>" method="POST">
            <div class="form-group">
                <div class="col-sm-4 col-lg-6">
                    <input type="text" class="form-control focusedInput" name="regionaam" id="name" value="<?php echo $regionaam ?>" required>
                </div>
                <div class="col-sm-4 col-lg-8">
                    <button  class="btn btn-default update" name="submit" >Regionaam wijzigen</button>
                </div>
            </div>
        </form>
        <!--form sluiten-->
