...
if(isset($_POST['submit'])){
    ...
    $regionaam = $_POST['regionaam'];

    //via named placeholders
    $STHadd = $DBH->prepare('INSERT INTO tblregio(regionaam)VALUE(:regionaam)');

    //named placeholders aanmaken
    $STHadd->bindParam(':regionaam', $regionaam);
    ...
    <div class="container-fluid">
        <form class="form-horizontal" id="form_members" role="form" action="" method="POST">
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <input type="text" class="form-control focusedInput" name="regionaam" id="name" placeholder="" required autofocus>
                </div>

                <div class="form-group">
                    <div class="col-sm-3 text-right" >
                        <button type="submit" class="btn btn-block btn-primary" name="submit" id="submit">Wijnstreek toevoegen</button>
                    </div>
                </div>
            </div>
        </form>
        ...
        <table class="table">
            ...
            if($aantal==0){
                ...
                while ($row = $STHregio->fetch()) {
                    ...
                    echo '<td><a href="wijzigregio.php?regioid='. $regioid .'"><img src="../images/admin/update.png" height="20" width="20"></a><a href="verwijderregio.php?regioid='. $regioid .'"><img src="../images/admin/delete.png" height="20" width="20"></a></td></tr>';
                }
            }
