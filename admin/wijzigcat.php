...
<head>
    ...
    if(isset($_POST['submit'])){
        ...
        $STHadd = $DBH->prepare('UPDATE tblcategorie SET categorienaam = :categorienaam WHERE categorieid = :categorieid');

        //named placeholders aanmaken
        $STHadd->bindParam(':categorienaam', $categorienaam);
        $STHadd->bindParam(':categorieid', $categorieid);
...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-12">Wijziging categorie</div>
        </div><br><br>
        ...
        $STH = $DBH->prepare('SELECT * FROM tblcategorie WHERE categorieid = :categorieid');

        $categorieid = $_GET['catid'];

        $STH->bindParam(':categorieid', $categorieid);
        ...
        <form class="form-horizontal" id="form_members" role="form" action="wijzigcat.php?catid=<?php echo $categorieid;?>" method="POST">
            <div class="form-group">
                <div class="col-sm-4">
                    <input type="text" input class="form-control focusedInput" name="catnaam" id="name" value="<?php echo $categorienaam ?>" required>
                </div>
                ...
                <div class="form-group">
                    <div class="col-sm-10">
                        <button type="submit" class="btn btn-block btn-primary" name="submit" id="submit">Smaakprofiel wijzigen</button>
                    </div>
                </div>
            </div>
        </form>
